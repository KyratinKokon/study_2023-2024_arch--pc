...
![Создание и проверка работы файла вычисления арифметического выражения](image/1.png){#fig:001 width=70%}
...
![Пример  работы файла с двумя подпрограммами вычисления арифметического выражения ](image/2.png){#fig:002 width=70%}
...
![Создание и проверка работы файла печати сообщения и запуск отладки](image/3.png){#fig:003 width=70%}

Проверил работу программы, запустив ее в оболочке GDB с помощью команды run. (рис. @fig:004).

![Создание и проверка работы файла вычисления арифметического выражения](image/4.png){#fig:004 width=70%}

В режиме псевдографики gdb была установлена точка останова по адресу инструкции. (рис. @fig:005).

![Установил точка останова по адресу инструкции в режиме псевдографики](image/6.png){#fig:005 width=70%}
...
![Посмотр значение переменной по адресу используя отображения содержимого памяти](image/7.png){#fig:006 width=70%}

Посмотр позиции стека. Размер переменной - четыре байта и шаг изменения адреса равен размеру переменной (рис. @fig:007).

![Посмотр позиции стека и определение размера шага изменения адреса.](image/8.png){#fig:007 width=70%}
...
![Преобразовали программу из лабораторной работы №8, реализовав вычисление значения функции  как подпрограмму](image/9.png){#fig:008 width=70%}
...
![Создали файл вычисления арифметического выражения, проверили его работу, обратили внимание на ошибку и запустили отладку.](image/10.png){#fig:009 width=70%}
...
![Создание и проверка работы исправленного файла вычисления арифметического выражения](image/12.png){#fig:0011 width=70%}
